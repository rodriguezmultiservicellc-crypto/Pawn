...
export const en = {
  ...
  dashboard: {
    ...
    seeAll: 'See all',
    none: 'Nothing yet.',
    // ── Dashboard redesign (pawn-dashboard mockup) ──
    qaNewSale: 'New sale',
    qaNewSaleSub: 'Ring up a retail sale',
    qaNewLoan: 'New loan',
    qaNewLoanSub: 'Write a pawn ticket',
    qaNewRepair: 'New repair',
    qaNewRepairSub: 'Open a repair order',
    sectionMoney: 'Today & money',
    sectionAttention: 'Needs attention',
    sectionLibrary: 'Library',
    kpiTodaySales: "Today's sales",
    kpiTodaySalesSub: '{n} transactions',
    kpiOnLoan: 'On loan now',
    kpiOnLoanSub: '{n} active tickets',
    kpiInterestDue: 'Interest due (7 days)',
    kpiInterestDueSub: '{n} coming due',
    kpiOverdue: 'Overdue at risk',
    kpiOverdueSub: '{n} past due',
    attnDueWeek: 'Due this week',
    attnOverdue: 'Overdue loans',
    attnHold: 'Items on hold',
    attnReady: 'Ready for pickup',
    attnNeedParts: 'Repairs need parts',
    panelDueSoon: 'Loans due soon',
    panelActivity: 'Recent activity',
    emptyDueSoon: 'No active loans.',
    emptyActivity: 'No recent activity.',
    libCustomers: 'Customers on file',
    libInventory: 'Inventory on floor',
    libBanned: 'Banned customers',
    actSale: 'Retail sale',
    actNewLoan: 'New loan',
    actPayment: 'Payment',
    actRedemption: 'Redemption',
    actExtension: 'Extension',
    relOverdue: '{n} days overdue',
    relDueIn: 'in {n} days',
  ...
  customers: {
    ...
    eyeColor: 'Eye color',
    race: 'Race',
    // Option labels for the physical-description dropdowns. The STORED value
    // is language-neutral (see src/lib/customers/physical-description.ts);
    // only these labels change per locale.
    sexOptions: {
      male: 'Male',
      female: 'Female',
      other: 'Other',
    ...
    deleteBlocked: {
      prefix: "Can't delete this customer:",
      until: 'Records must be kept until {date}.',
      reasons: {
        active_loan: 'an open pawn loan',
        pawn_retention_window: 'a closed loan still inside the legal record-retention period',
  ...
  pawn: {
    ...
    drafts: {
      navTitle: 'Drafts',
      title: 'Saved drafts',
      subtitle: 'In-progress pawn intakes. Continue one to finish issuing it.',
      empty: 'No saved drafts. Start a ticket and hit "Save as draft" to park it here.',
      backToLoans: 'Back to pawn loans',
      customer: 'Customer',
      items: 'Items',
      principal: 'Principal',
      savedAt: 'Saved',
    ...
    list: {
      ...
      searchPlaceholder: 'Search by ticket, customer name, or phone…',
      // ── Pawn loans list redesign (stats strip + collateral/payoff + row actions) ──
      collateral: 'Collateral',
      payoffDue: 'Payoff due',
      intSuffix: 'int',
      moreCount: '+{n}',
      takePayment: 'Take payment',
      view: 'View',
      viewTicket: 'View ticket',
      extendRenew: 'Extend / renew',
      redeem: 'Redeem',
      printTicket: 'Print ticket',
      markForfeited: 'Mark forfeited',
      rowActions: 'Row actions',
      relOverdue: '{n} days overdue',
      relDueIn: 'in {n} days',
      statOnLoan: 'On loan now',
      statOnLoanSub: '{n} active tickets',
      statDueSoon: 'Due soon (7 days)',
      statDueSoonSub: '{amount} to redeem',
      statOverdue: 'Overdue',
      statOverdueSub: '{amount} at risk',
      statRedeemed: 'Redeemed (30 days)',
      statRedeemedSub: '{amount} interest earned',
    },
    statusActive: 'Active',
    ...
    new_: {
      ...
      quickCustomerTitle: 'New customer',
      quickCustomerHelp: 'Create a customer without leaving this ticket.',
      quickCustomerIdSection: 'Identification',
      quickCustomerSave: 'Create customer',
      quickCustomerError: 'Could not create the customer. Check the fields and try again.',
      saveDraft: 'Save as draft',
      draftSaving: 'Saving draft…',
      // ── New pawn ticket redesign (two-pane work surface + loan rail) ──
      financingPawn: 'Pawn loan',
      financingBuy: 'Buy outright',
      railSummaryTitle: 'Loan summary',
      railNoCustomer: 'No customer selected',
      collateralValue: 'Collateral value',
      ltvCovered: '{pct}% of value',
      ltvOver: 'Over value',
      itemOne: 'item',
      itemMany: 'items',
      collateralItemsLabel: 'Collateral items',
      redemptionLabel: 'Redemption at due date',
      redemptionIncludes: 'includes {amount} interest',
      manageRatesHint: 'Manage rates in Settings → Loan rates.',
      railMissingHint: 'Add a customer, principal, and at least one item',
      principal: 'Principal',
  ...
  repair: {
    ...
    new_: {
      ...
      sectionStaff: 'Repair notes',
      pickCustomer: 'Pick a customer',
      pickCustomerHelp:
        'Customer must be on file before opening a repair ticket.',
      newCustomer: 'Create new customer',
      customer: 'Customer',
      // ── Multi-item intake (title-builder chips) ──
      itemsHelp:
        'Add each item the customer is dropping off. Build its title from the chips, pick the service, and note the work needed.',
      itemLabel: 'Item {n}',
      itemType: 'Item type',
      itemTypes: {
        ring: 'Ring',
      ...
      dimensionPlaceholder: 'e.g. 18", sz 7',
      service: 'Service',
      workNeeded: 'Work needed',
      workNeededPlaceholder: 'e.g. solder by clasp',
      titlePreview: 'Title',
      titleEmpty: 'Pick an item type to start the title',
      addItem: 'Add item',
      removeItem: 'Remove',
      ...
      stoneNotes: 'Notes',
      notesInternal: 'Repair notes (tech)',
      notesInternalHelp:
      ...
      railNoCustomer: 'No customer selected',
      railItemsTitle: 'Items',
      railNoItems: 'No items yet',
      photosHelp:
      ...
      railMissingHint: 'Pick a customer and add at least one item',
    },
    detail: {
      ticketLabel: 'Ticket',
      customerLabel: 'Customer',
  ...
  pos: {
    ...
    sale: {
      ...
      // ── New-sale redesign (two-pane work surface + checkout rail) ──
      scanPlaceholder: 'Scan tag or search by SKU, item, or barcode…',
      enterHint: 'Enter',
      noItemFound: "No item found for '{q}'",
      ...
      tenderCard: 'Card',
      tenderSplit: 'Split',
      splitSoon: 'Split tender coming soon',
      charge: 'Charge {amount}',
      addNote: 'Add note to sale',
    },
    cart: {
      qty: 'Qty',
  ...
  settingsLoanRates: {
    ...
    backpageSubtitle:
      "Reverse-side legal disclosure printed on every pawn ticket. English only — the ticket is a legal document. Leave blank to use your jurisdiction's statutory default.",
    backpageUsingDefault: "Using your jurisdiction's statutory default text.",
  ...
  jurisdiction: {
    errors: {
      jurisdiction_rate_cap:
        'This rate exceeds the legal maximum of {value} per period in your jurisdiction.',
      jurisdiction_min_charge_cap:
        'This minimum charge exceeds the legal maximum of {value} per period.',
      jurisdiction_term_min: 'The loan term must be at least {value} days in your jurisdiction.',
      jurisdiction_term_max: 'The loan term can be at most {value} days in your jurisdiction.',
      forfeit_not_eligible_until:
        "This loan can't be forfeited until {value} (maturity plus the legal grace period).",
      buy_hold_active_until: 'This purchased item is on its legal hold until {value}.',
      buy_hold_cannot_shorten: "A purchase hold can't be shortened.",
      repair_abandon_not_eligible_until:
        "This repair can't be marked abandoned until {value}.",
    },
    termFixed: 'Fixed at {days} days by {name} law.',
    lastRedemptionDay: 'Last day to redeem',
    forfeitEligibleOn: 'Forfeiture allowed from {date}',
    rateCapNote: '{name} limit: {rate} per period, minimum charge up to {min}.',
    settings: {
      title: 'Jurisdiction & legal rules',
      subtitle:
        'The state or province your shop operates in sets the legal limits Sol Pawn enforces: rate cap, loan term, grace before forfeiture, buy hold, and record retention.',
      cardDescription:
        'Pick your jurisdiction and timezone. Rate caps, grace periods, and holds are enforced from it.',
      cardStatus: '{name} · grace {grace}d · hold {hold}d',
      noJurisdiction:
        'No jurisdiction on file — legal limits are NOT being enforced for this shop. Pick one below.',
      jurisdiction: 'Jurisdiction',
      jurisdictionNone: 'None selected',
      jurisdictionHelp:
        "Don't see your state? Contact Sol Pawn support — we add jurisdictions after verifying the statute.",
      timezone: 'Shop timezone',
      timezoneHelp: 'Due dates, holds, and forfeiture are counted on this calendar.',
      graceDays: 'Grace period after maturity (days)',
      buyHoldDays: 'Buy-outright hold (days)',
      repairAbandonDays: 'Repair abandonment period (days)',
      effectiveNow:
        'In effect now: grace {grace} · buy hold {hold} · repair abandonment {abandon}.',
      ownerOnly: 'Only the owner can change these settings.',
      belowStatute: 'Must be at least {days} days (the legal minimum).',
      daysValue: '{n} days',
      yearsValue: '{n} years',
      statutoryTitle: 'Legal limits — {name}',
      rateCap: 'Rate cap',
      tieredSuffix: '(tiered)',
      minChargeCap: 'Max minimum charge',
      term: 'Loan term',
      statutoryGrace: 'Grace period',
      statutoryHold: 'Buy hold',
      statutoryAbandon: 'Repair abandonment',
      notGoverned: 'Not set by statute',
      retention: 'Record retention',
      policeReporting: 'Police reporting',
      required: 'Required',
      notRequired: 'Not required',
      verifiedOn: 'Verified against the statute on {date}.',
      unverified: 'Not yet verified against the statute — confirm before relying on it.',
      statutoryMin: 'Legal minimum: {n} days',
      noStatutoryMin: 'No legal minimum on file',
    },
    admin: {
      navLabel: 'Jurisdictions',
      title: 'Jurisdictions',
      subtitle:
        'Statutory rule sets per state / province. Tenants pick one; Sol Pawn enforces its limits in the database. Only add a jurisdiction after verifying the current statute.',
      add: 'Add jurisdiction',
      colCode: 'Code',
      colName: 'Name',
      colRateCap: 'Rate cap',
      colGrace: 'Grace (d)',
      colHold: 'Hold (d)',
      colRetention: 'Retention (y)',
      colTenants: 'Tenants',
      colVerified: 'Verified',
      empty: 'No jurisdictions yet.',
      unverifiedBadge: 'unverified',
      errTiers: 'Tiers must be a JSON array of {"up_to": number|null, "rate": number}.',
      errNotices: 'Notices must be a JSON array of {"bold": bool, "en": text, "es": text}, each with English text.',
      errCodeImmutable: "The country / region code can't be changed.",
      errTermRange: 'Minimum term must be less than or equal to the maximum.',
      errDuplicate: 'That jurisdiction already exists.',
      country: 'Country',
      region: 'Region code',
      regionHelp: 'Two-letter state / province code, e.g. FL.',
      name: 'Name',
      timezone: 'Default timezone',
      statute: 'Statute citation',
      sectionLoan: 'Pawn loans',
      rateCapPercent: 'Rate cap (% per period)',
      rateCapHelp: 'Max total service charge per period. Blank = no cap.',
      periodDays: 'Period (days)',
      minChargeCap: 'Max minimum charge ($)',
      minChargeCapHelp: 'Highest per-period minimum a shop may charge.',
      graceDays: 'Grace after maturity (days)',
      minTermDays: 'Min term (days)',
      maxTermDays: 'Max term (days)',
      graceRolls: 'Last grace day rolls to the next business day when it falls on a weekend',
      rateTiers: 'Tiered cap (optional JSON)',
      rateTiersHelp: 'When set, overrides the flat cap: the blended rate across principal slices is enforced.',
      sectionOther: 'Purchases, repairs, records',
      buyHoldDays: 'Buy-outright hold (days)',
      repairAbandonDays: 'Repair abandonment (days)',
      optionalHelp: 'Blank = not governed by statute.',
      retentionYears: 'Record retention (years)',
      policeReporting: 'Police reporting required',
      sectionTicket: 'Pawn ticket text',
      notices: 'Legal notices (JSON)',
      noticesHelp: 'Printed in the ticket legal block. Spanish is a courtesy translation.',
      backpage: 'Default reverse-side text (English)',
