...
export const es: Dictionary = {
  common: {
    ...
    customerPicker: {
      ...
      placeholderWithDl: 'Buscar por nombre, teléfono, licencia — o escanear ID →',
      typeMore: 'Escribe al menos 2 caracteres para buscar.',
      searching: 'Buscando…',
      noResults: 'Sin resultados. Prueba el apellido, teléfono o número de licencia.',
      clear: 'Borrar selección',
      scanButton: 'Escanear ID',
      scanNoMatch: 'No se encontró un cliente con esa licencia.',
      scanNoNumber: 'El escaneo no devolvió un número de licencia. Intenta de nuevo.',
    },
    save: 'Guardar',
    saving: 'Guardando…',
    cancel: 'Cancelar',
  ...
  dashboard: {
    ...
    seeAll: 'Ver todos',
    none: 'Aún nada.',
    // ── Rediseño del panel (mockup pawn-dashboard) ──
    qaNewSale: 'Nueva venta',
    qaNewSaleSub: 'Registrar una venta',
    qaNewLoan: 'Nuevo préstamo',
    qaNewLoanSub: 'Escribir un boleto de empeño',
    qaNewRepair: 'Nueva reparación',
    qaNewRepairSub: 'Abrir una orden de reparación',
    sectionMoney: 'Hoy y dinero',
    sectionAttention: 'Requiere atención',
    sectionLibrary: 'Biblioteca',
    kpiTodaySales: 'Ventas de hoy',
    kpiTodaySalesSub: '{n} transacciones',
    kpiOnLoan: 'En préstamo',
    kpiOnLoanSub: '{n} boletos activos',
    kpiInterestDue: 'Interés por cobrar (7 días)',
    kpiInterestDueSub: '{n} por vencer',
    kpiOverdue: 'Vencidos en riesgo',
    kpiOverdueSub: '{n} pasados de fecha',
    attnDueWeek: 'Vencen esta semana',
    attnOverdue: 'Préstamos vencidos',
    attnHold: 'Artículos retenidos',
    attnReady: 'Listos para recoger',
    attnNeedParts: 'Reparaciones sin piezas',
    panelDueSoon: 'Préstamos por vencer',
    panelActivity: 'Actividad reciente',
    emptyDueSoon: 'No hay préstamos activos.',
    emptyActivity: 'No hay actividad reciente.',
    libCustomers: 'Clientes registrados',
    libInventory: 'Inventario en exhibición',
    libBanned: 'Clientes vetados',
    actSale: 'Venta',
    actNewLoan: 'Nuevo préstamo',
    actPayment: 'Pago',
    actRedemption: 'Redención',
    actExtension: 'Extensión',
    relOverdue: '{n} días vencido',
    relDueIn: 'en {n} días',
    relDueToday: 'vence hoy',
  },
  ...
  customers: {
    ...
    dashboard: {
      ...
      lifetimeStatsTitle: 'Estadísticas de por vida',
      statPawns: 'Empeños',
      statLoaned: 'Prestado',
      statActive: 'Préstamos activos',
      statLost: 'Empeños perdidos',
      statSales: 'Ventas',
      statSpent: 'Gastado',
      statRepairs: 'Reparaciones',
      statLayaways: 'Apartados',
      statInterestPaid: 'Interés pagado',
      statExtensions: 'Extensiones',
      statOnTime: 'Pagos a tiempo',
      statLoyalty: 'Lealtad',
      activeAbbrev: 'activos',
      pointsAbbrev: 'pts',
      pawnBehaviorTitle: 'Comportamiento de empeño',
      behaviorTabPawn: 'Empeños',
      behaviorTabSales: 'Ventas',
      behaviorTabLayaway: 'Apartados',
      behaviorTabCustomOrders: 'Órdenes personalizadas',
      behaviorEmpty: 'Aún no hay actividad en esta categoría.',
      behaviorAvgPrincipal: 'Capital prom.',
      behaviorRedemptionRate: 'Tasa de rescate',
      behaviorForfeitRate: 'Tasa de pérdida',
      behaviorExtensionRate: 'Tasa de extensión',
      behaviorAvgDaysLate: 'Días de retraso prom.',
      salesAvgTotal: 'Venta prom.',
      salesLargest: 'Venta más grande',
      salesDaysSinceLast: 'Días desde última',
      salesAvgDaysBetween: 'Días promedio entre',
      salesCompletedCount: 'Ventas completadas',
      layawayAvgTotal: 'Total prom.',
      layawayActiveCount: 'Activos',
      layawayAvgPaidPct: '% pagado prom.',
      layawayOutstanding: 'Saldo pendiente',
      layawayTotalCount: 'Total apartados',
      repairAvgBalance: 'Saldo prom.',
      repairActiveCount: 'Activas',
      repairCompletedCount: 'Completadas',
      repairMostCommonType: 'Más común',
      repairTotalCount: 'Total órdenes',
      serviceTypeRepair: 'Reparación',
      serviceTypeStoneSetting: 'Engaste',
      serviceTypeSizing: 'Ajuste de talla',
      serviceTypeRestring: 'Reensartado',
      serviceTypePlating: 'Baño',
      serviceTypeEngraving: 'Grabado',
      serviceTypeCustom: 'Personalizado',
      trendsTitle: 'Tendencias',
      trendsSubtitle: 'Últimos 12 meses — transacciones por módulo',
      legendPawns: 'Empeños',
      legendSales: 'Ventas',
      legendRepairs: 'Reparaciones',
      legendLayaways: 'Apartados',
      lostPawnsTitle: 'Empeños perdidos',
      lostPawnsCount: 'no rescatados',
      lostPawnsEmpty: 'No hay préstamos no rescatados en el registro.',
      noCollateralListed: 'Sin colateral registrado',
      activityTitle: 'Actividad reciente',
      activityWindow: 'Últimos 60 días',
      activityEmpty: 'Sin actividad en los últimos 60 días.',
      activityLoanEventPrefix: 'Préstamo',
      activitySalePrefix: 'Venta',
      activityRepairPrefix: 'Reparación',
      activityLayawayPrefix: 'Apartado',
    },
    ...
    race: 'Raza',
    // Etiquetas de las listas de descripción física. El valor GUARDADO es
    // neutral al idioma (ver src/lib/customers/physical-description.ts);
    // aquí solo cambia lo que ve el usuario.
    sexOptions: {
      male: 'Masculino',
      female: 'Femenino',
      other: 'Otro',
    ...
    deleteBlocked: {
      prefix: 'No se puede eliminar este cliente:',
      until: 'Los registros deben conservarse hasta el {date}.',
      reasons: {
        active_loan: 'un préstamo de empeño abierto',
        pawn_retention_window: 'un préstamo cerrado aún dentro del período legal de conservación de registros',
  ...
  pawn: {
    ...
    drafts: {
      ...
      subtitle: 'Empeños en progreso. Continúa uno para terminar de emitirlo.',
      empty: 'No hay borradores. Inicia un boleto y presiona «Guardar borrador» para guardarlo aquí.',
      backToLoans: 'Volver a empeños',
      customer: 'Cliente',
      items: 'Artículos',
      principal: 'Principal',
      savedAt: 'Guardado',
      noPrincipal: 'Sin definir',
      continue: 'Continuar',
      discard: 'Descartar',
    },
    list: {
      ...
      searchPlaceholder: 'Buscar por boleto, cliente o teléfono…',
      // ── Rediseño de la lista de empeños (resumen + garantía/saldo + acciones) ──
      collateral: 'Garantía',
      payoffDue: 'Saldo a pagar',
      intSuffix: 'int',
      moreCount: '+{n}',
      takePayment: 'Cobrar pago',
      view: 'Ver',
      viewTicket: 'Ver boleto',
      extendRenew: 'Extender / renovar',
      redeem: 'Redimir',
      printTicket: 'Imprimir boleto',
      markForfeited: 'Marcar no rescatado',
      rowActions: 'Acciones de fila',
      relOverdue: '{n} días vencido',
      relDueIn: 'en {n} días',
      statOnLoan: 'En préstamo',
      statOnLoanSub: '{n} boletos activos',
      statDueSoon: 'Por vencer (7 días)',
      statDueSoonSub: '{amount} por redimir',
      statOverdue: 'Vencidos',
      statOverdueSub: '{amount} en riesgo',
      statRedeemed: 'Redimidos (30 días)',
      statRedeemedSub: '{amount} interés ganado',
    },
    statusActive: 'Activo',
    ...
    new_: {
      ...
      quickCustomerTitle: 'Nuevo cliente',
      quickCustomerHelp: 'Crea un cliente sin salir de este boleto.',
      quickCustomerIdSection: 'Identificación',
      quickCustomerSave: 'Crear cliente',
      quickCustomerError: 'No se pudo crear el cliente. Revisa los campos e inténtalo de nuevo.',
      saveDraft: 'Guardar borrador',
      draftSaving: 'Guardando borrador…',
      // ── Rediseño de nuevo empeño (panel de trabajo + barra del préstamo) ──
      financingPawn: 'Préstamo de empeño',
      financingBuy: 'Compra directa',
      railSummaryTitle: 'Resumen del préstamo',
      railNoCustomer: 'Ningún cliente seleccionado',
      collateralValue: 'Valor de la prenda',
      ltvCovered: '{pct}% del valor',
      ltvOver: 'Sobre el valor',
      itemOne: 'artículo',
      itemMany: 'artículos',
      collateralItemsLabel: 'Artículos en prenda',
      redemptionLabel: 'Rescate en la fecha de vencimiento',
      redemptionIncludes: 'incluye {amount} de interés',
      manageRatesHint: 'Administra las tasas en Configuración → Tasas de préstamo.',
      railMissingHint: 'Agrega un cliente, capital y al menos un artículo',
      principal: 'Principal',
  ...
  repair: {
    ...
    new_: {
      ...
      sectionCustomer: 'Cliente',
      sectionItem: 'Artículos',
      sectionStones: 'Piedras',
      sectionPhotos: 'Fotos al recibir',
      sectionStaff: 'Notas de reparación',
      pickCustomer: 'Selecciona un cliente',
      pickCustomerHelp:
        'El cliente debe estar registrado antes de abrir una orden de reparación.',
      newCustomer: 'Crear nuevo cliente',
      customer: 'Cliente',
      // ── Recepción de múltiples artículos (chips para el título) ──
      itemsHelp:
        'Agrega cada artículo que deja el cliente. Arma su título con los chips, elige el servicio y anota el trabajo requerido.',
      itemLabel: 'Artículo {n}',
      ...
      karat: 'Metal / quilates',
      weightGrams: 'Peso (g)',
      weightPlaceholder: '0.0',
      dimension: 'Largo / talla',
      dimensionPlaceholder: 'p. ej. 18", talla 7',
      service: 'Servicio',
      workNeeded: 'Trabajo requerido',
      workNeededPlaceholder: 'p. ej. soldar en el broche',
      titlePreview: 'Título',
      titleEmpty: 'Elige un tipo de artículo para armar el título',
      addItem: 'Agregar artículo',
      removeItem: 'Quitar',
      atLeastOneItem: 'Agrega al menos un artículo.',
      ...
      stoneNotes: 'Notas',
      notesInternal: 'Notas de reparación (técnico)',
      notesInternalHelp:
      ...
      railItemsTitle: 'Artículos',
      railNoItems: 'Aún no hay artículos',
      photosHelp:
      ...
      railMissingHint: 'Elige un cliente y agrega al menos un artículo',
    },
    detail: {
      ticketLabel: 'Orden',
      customerLabel: 'Cliente',
  ...
  pos: {
    ...
    sale: {
      ...
      // ── Rediseño de nueva venta (panel de trabajo + barra de cobro) ──
      scanPlaceholder: 'Escanea la etiqueta o busca por SKU, artículo o código…',
      enterHint: 'Enter',
      noItemFound: "No se encontró un artículo para '{q}'",
      ...
      eachSuffix: 'c/u',
      qtyDecrease: 'Disminuir cantidad',
      qtyIncrease: 'Aumentar cantidad',
      tender: 'Forma de pago',
      tenderCash: 'Efectivo',
      tenderCard: 'Tarjeta',
      tenderSplit: 'Dividido',
      splitSoon: 'Pago dividido próximamente',
      charge: 'Cobrar {amount}',
      addNote: 'Agregar nota a la venta',
    },
    cart: {
      qty: 'Cant.',
  ...
  settingsLoanRates: {
    ...
    backpageSubtitle:
      'Aviso legal impreso en el reverso de cada boleto de empeño. Solo en inglés — el boleto es un documento legal. Déjalo vacío para usar el texto legal de tu jurisdicción.',
    backpageUsingDefault: 'Usando el texto legal de tu jurisdicción.',
  ...
  imports: {
    ...
    subtitle:
      'Trae clientes desde otro sistema de empeño. Previsualiza antes de confirmar — se puede re-ejecutar sin duplicados.',
    step1: '1. Elige el sistema de origen',
    xpawnDesc:
      'Preajuste de un clic. Mapea automáticamente cada columna del Customers.csv de xPawn.',
    genericDesc:
      'Cualquier CSV — Bravo y otros. Mapea por nombre de columna; ajusta antes de importar.',
    vendorLabel: 'Nombre del proveedor (opcional)',
    vendorPlaceholder: 'p. ej. Bravo',
    step2: '2. Sube el CSV',
    ...
    insertedMsg: 'Se insertaron {n} clientes.',
    viewCustomers: 'Ver clientes',
    importAnother: 'Importar otro archivo',
    mappingTitle: 'Mapeo de columnas',
    mappingHelp:
      'Emparejamos tus columnas con los campos de Sol Pawn. Corrige las incorrectas y actualiza la previsualización.',
    skip: '— omitir —',
    updatePreview: 'Actualizar previsualización',
    reportTitle: 'Previsualización',
    rParsed: 'Filas leídas',
    rToInsert: 'A insertar',
    rNoName: 'Omitidas (sin nombre)',
    rDup: 'Omitidas (clave dup)',
    rExisting: 'Omitidas (ya existen)',
    rDob: 'Fecha nac. no interpretada',
    cName: 'Nombre',
    cDob: 'Nacimiento',
    cPhone: 'Teléfono',
    cIdType: 'Tipo de ID',
    cCity: 'Ciudad',
    importBtn: 'Importar {n} clientes',
    importing: 'Importando…',
  },

  jurisdiction: {
    errors: {
      jurisdiction_rate_cap:
        'Esta tasa supera el máximo legal de {value} por período en tu jurisdicción.',
      jurisdiction_min_charge_cap:
        'Este cargo mínimo supera el máximo legal de {value} por período.',
      jurisdiction_term_min: 'El plazo del préstamo debe ser de al menos {value} días en tu jurisdicción.',
      jurisdiction_term_max: 'El plazo del préstamo puede ser de máximo {value} días en tu jurisdicción.',
      forfeit_not_eligible_until:
        'Este préstamo no puede darse por perdido hasta el {value} (vencimiento más el período de gracia legal).',
      buy_hold_active_until: 'Este artículo comprado está en retención legal hasta el {value}.',
      buy_hold_cannot_shorten: 'La retención de una compra no se puede acortar.',
      repair_abandon_not_eligible_until:
        'Esta reparación no puede marcarse como abandonada hasta el {value}.',
    },
    termFixed: 'Fijado en {days} días por la ley de {name}.',
    lastRedemptionDay: 'Último día para rescatar',
    forfeitEligibleOn: 'Pérdida permitida desde el {date}',
    rateCapNote: 'Límite de {name}: {rate} por período, cargo mínimo de hasta {min}.',
    settings: {
      title: 'Jurisdicción y reglas legales',
      subtitle:
        'El estado o provincia donde opera tu tienda define los límites legales que Sol Pawn aplica: tope de tasa, plazo del préstamo, gracia antes de la pérdida, retención de compras y conservación de registros.',
      cardDescription:
        'Elige tu jurisdicción y zona horaria. Los topes de tasa, períodos de gracia y retenciones se aplican a partir de ella.',
      cardStatus: '{name} · gracia {grace}d · retención {hold}d',
      noJurisdiction:
        'No hay jurisdicción registrada — los límites legales NO se están aplicando en esta tienda. Elige una abajo.',
      jurisdiction: 'Jurisdicción',
      jurisdictionNone: 'Ninguna seleccionada',
      jurisdictionHelp:
        '¿No ves tu estado? Contacta a soporte de Sol Pawn — agregamos jurisdicciones después de verificar la ley.',
      timezone: 'Zona horaria de la tienda',
      timezoneHelp: 'Los vencimientos, retenciones y pérdidas se cuentan según este calendario.',
      graceDays: 'Período de gracia tras el vencimiento (días)',
      buyHoldDays: 'Retención de compras directas (días)',
      repairAbandonDays: 'Plazo de abandono de reparaciones (días)',
      effectiveNow:
        'Vigente ahora: gracia {grace} · retención de compras {hold} · abandono de reparaciones {abandon}.',
      ownerOnly: 'Solo el propietario puede cambiar esta configuración.',
      belowStatute: 'Debe ser de al menos {days} días (el mínimo legal).',
      daysValue: '{n} días',
      yearsValue: '{n} años',
      statutoryTitle: 'Límites legales — {name}',
      rateCap: 'Tope de tasa',
      tieredSuffix: '(escalonado)',
      minChargeCap: 'Cargo mínimo máximo',
      term: 'Plazo del préstamo',
      statutoryGrace: 'Período de gracia',
      statutoryHold: 'Retención de compras',
      statutoryAbandon: 'Abandono de reparaciones',
      notGoverned: 'No lo fija la ley',
      retention: 'Conservación de registros',
      policeReporting: 'Reporte a la policía',
      required: 'Obligatorio',
      notRequired: 'No obligatorio',
      verifiedOn: 'Verificado contra la ley el {date}.',
      unverified: 'Aún no verificado contra la ley — confírmalo antes de confiar en él.',
      statutoryMin: 'Mínimo legal: {n} días',
      noStatutoryMin: 'Sin mínimo legal registrado',
    },
    admin: {
      navLabel: 'Jurisdicciones',
      title: 'Jurisdicciones',
      subtitle:
        'Conjuntos de reglas legales por estado / provincia. Cada tienda elige uno; Sol Pawn aplica sus límites en la base de datos. Agrega una jurisdicción solo después de verificar la ley vigente.',
      add: 'Agregar jurisdicción',
      colCode: 'Código',
      colName: 'Nombre',
      colRateCap: 'Tope de tasa',
      colGrace: 'Gracia (d)',
      colHold: 'Retención (d)',
      colRetention: 'Conservación (a)',
      colTenants: 'Tiendas',
      colVerified: 'Verificado',
      empty: 'Aún no hay jurisdicciones.',
      unverifiedBadge: 'sin verificar',
      errTiers: 'Los tramos deben ser un arreglo JSON de {"up_to": número|null, "rate": número}.',
      errNotices: 'Los avisos deben ser un arreglo JSON de {"bold": bool, "en": texto, "es": texto}, cada uno con texto en inglés.',
      errCodeImmutable: 'El código de país / región no se puede cambiar.',
      errTermRange: 'El plazo mínimo debe ser menor o igual al máximo.',
      errDuplicate: 'Esa jurisdicción ya existe.',
      country: 'País',
      region: 'Código de región',
      regionHelp: 'Código de estado / provincia de dos letras, p. ej. FL.',
      name: 'Nombre',
      timezone: 'Zona horaria predeterminada',
      statute: 'Cita de la ley',
      sectionLoan: 'Préstamos de empeño',
      rateCapPercent: 'Tope de tasa (% por período)',
      rateCapHelp: 'Cargo total máximo por período. Vacío = sin tope.',
      periodDays: 'Período (días)',
      minChargeCap: 'Cargo mínimo máximo ($)',
      minChargeCapHelp: 'El mínimo por período más alto que una tienda puede cobrar.',
      graceDays: 'Gracia tras el vencimiento (días)',
      minTermDays: 'Plazo mínimo (días)',
      maxTermDays: 'Plazo máximo (días)',
      graceRolls: 'El último día de gracia pasa al siguiente día hábil si cae en fin de semana',
      rateTiers: 'Tope escalonado (JSON opcional)',
      rateTiersHelp: 'Si se define, reemplaza el tope fijo: se aplica la tasa combinada por tramos del principal.',
      sectionOther: 'Compras, reparaciones, registros',
      buyHoldDays: 'Retención de compras directas (días)',
      repairAbandonDays: 'Abandono de reparaciones (días)',
      optionalHelp: 'Vacío = no lo regula la ley.',
      retentionYears: 'Conservación de registros (años)',
      policeReporting: 'Reporte a la policía obligatorio',
      sectionTicket: 'Texto del boleto de empeño',
      notices: 'Avisos legales (JSON)',
      noticesHelp: 'Se imprimen en el bloque legal del boleto. El español es una traducción de cortesía.',
      backpage: 'Texto del reverso predeterminado (inglés)',
