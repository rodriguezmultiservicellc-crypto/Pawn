...
import { getInventoryTurn } from '@/lib/reports/inventory-turn'
import { todayDateString, addDaysIso } from '@/lib/pawn/math'
import InventoryTurnContent from './content'

export const dynamic = 'force-dynamic'

type SearchParams = Promise<{ from?: string; to?: string }>

export default async function InventoryTurnPage(props: {
