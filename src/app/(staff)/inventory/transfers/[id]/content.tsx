    ...
    <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="flex items-center gap-2">
          {showCancelButton ? (
            <button
              ...
              onClick={onCancel}
              disabled={pending}
              className="inline-flex items-center gap-1 rounded-md border border-border bg-card px-3 py-2 text-sm text-foreground hover:border-danger hover:text-danger disabled:opacity-50"
            >
          ...
          {showAcceptRejectButtons ? (
            <>
              ...
              <button
                ...
                onClick={onAccept}
                disabled={pending}
                className="inline-flex items-center gap-1 rounded-md bg-success px-3 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-50"
              >
      ...
      <div className="rounded-lg border border-border bg-card p-5">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-7 sm:items-center">
          ...
          <div className="hidden text-center sm:col-span-1 sm:block">
            <ArrowRight size={22} weight="bold" className="mx-auto text-muted" />
          </div>
          <div className="sm:col-span-3">
            <p className="text-xs uppercase tracking-wide text-muted">
      ...
      <div className="rounded-lg border border-border bg-card p-5">
        ...
        <ul className="space-y-2 text-sm">
          ...
          {data.rejected_at ? (
            <TimelineRow
              icon={<Prohibit size={14} className="text-danger" />}
          ...
          {data.cancelled_at ? (
            <TimelineRow
              icon={<X size={14} className="text-muted" />}
